...
const ErrorState = React.forwardRef<HTMLDivElement, ErrorStateProps>(
  ({ 
    ...
    <div
      ref={ref}
      className={cn(errorStateVariants({ padding, variant, className }))}
      {...props}
    >
...
const NotFoundErrorState = ({ resourceName = "resource", ...props }: { resourceName?: string } & Omit<ErrorStateProps, "title" | "showRetry">) => (
  <ErrorState
