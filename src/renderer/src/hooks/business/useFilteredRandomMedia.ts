...
type MediaSelectorResult = {
  selectRandomMedia: (filters?: MediaFilters) => Promise<{
    media: Media | null;
    totalAvailable: number;
  }>;
};

export const useMediaSelector = (): MediaSelectorResult => {
  const selectRandomMedia = useCallback(
    async (
