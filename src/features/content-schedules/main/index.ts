...
export const registerContentScheduleHandlers = () => {
  ...
  ipcMain.handle("content-schedule:create", async (_, data: Omit<ContentSchedule, "id" | "createdAt" | "updatedAt">) => {
  ...
  ipcMain.handle(
    ...
    async (_, id: string, updates: Partial<Omit<ContentSchedule, "id" | "createdAt" | "updatedAt">>) => {
