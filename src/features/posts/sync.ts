...
import { updateContentSchedule } from "../content-schedules/operations";
import { PostWithoutRelations } from "./entity";
import { createPost, deletePost, fetchPostsBySchedule, updatePost } from "./operations";
...
export const syncPostsForSchedule = async (schedule: ContentSchedule) => {
  ...
  const operations: (() => Promise<PostWithoutRelations | null | void>)[] = [];
