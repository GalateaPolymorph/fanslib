      ...
      <div className='drawer-content flex flex-col min-h-screen'>
        <header className='main-header navbar bg-base-100 shadow-sm border-b border-base-300 lg:hidden h-16 px-4'>
          <div className='flex-none'>
            <label htmlFor='drawer-toggle' className='btn btn-square btn-ghost min-h-12 min-w-12'>
              <BurgerIcon />
            </label>
          </div>
        ...
        <main className='flex-1 p-4 sm:p-6 lg:p-8 content-area overflow-x-auto'>{children}</main>
      </div>
          ...
          <div className='p-4 lg:p-6 border-b border-base-300'>
            <div className='flex items-center space-x-3'>
              <div className='w-8 h-8 lg:w-10 lg:h-10 bg-primary rounded-lg flex items-center justify-center'>
                <span className='text-primary-content font-bold text-lg lg:text-xl'>F</span>
              </div>
