export const ResponsiveDemo = () => {
  return (
    <div className='space-y-6'>
      ...
      <section>
        ...
        <div className='bg-base-200 p-4 tablet:p-6 desktop:p-8 rounded-lg'>
          ...
          <p className='text-sm tablet:text-base desktop:text-lg text-base-content/80 mb-3 tablet:mb-4 desktop:mb-6'>
            This paragraph demonstrates responsive text sizing. Padding and margins also scale
            appropriately across different screen sizes to maintain optimal reading experience.
          </p>
        ...
        <div className='grid grid-cols-1 tablet:grid-cols-2 gap-4'>
          <div className='bg-base-200 p-4 rounded-lg'>
            ...
            <div className='space-y-2'>
              <button className='btn btn-primary w-full min-h-11'>Touch-Friendly Button</button>
              <button className='btn btn-ghost w-full min-h-11'>44px+ Height Button</button>
            </div>
          </div>
      ...
      {/* Content Status Demo */}
      <section>
        <h3 className='text-lg font-semibold mb-4 text-base-content'>Content Status Indicators</h3>
      ...
      <section>
        ...
        <div className='bg-base-200 p-4 rounded-lg text-center'>
          <div className='font-mono text-sm'>
            <span className='inline tablet:hidden desktop:hidden'>📱 Mobile (&lt; 768px)</span>
            <span className='hidden tablet:inline desktop:hidden'>📟 Tablet (768px - 1023px)</span>
