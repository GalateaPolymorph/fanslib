...
import { useDateRangePicker, useDateSegment, useDateField } from 'react-aria';
import { useDateRangePickerState, useDateFieldState } from 'react-stately';
...
import { useLocale, useCalendarGrid, useCalendarCell } from 'react-aria';
      ...
      <div className="relative">
        <div {...groupProps} ref={ref} className="flex gap-2">
          <div className="input input-bordered flex items-center flex-1 px-3">
            <DateField {...startFieldProps} state={state.startFieldState} />
            <span className="mx-2">–</span>
            <DateField {...endFieldProps} state={state.endFieldState} />
          </div>
          <Button
            {...buttonProps}
            variant="ghost"
