        ...
        <div className='grid grid-cols-1 lg:grid-cols-4 gap-6'>
          ...
          <div className='lg:col-span-3'>
            ...
            <div className='bg-base-100 border border-base-300 rounded-lg overflow-hidden'>
              ...
              <div className='grid grid-cols-7 bg-base-200'>
                {['Sun', 'Mon', 'Tue', 'Wed', 'Thu', 'Fri', 'Sat'].map(day => (
                  <div key={day} className='p-3 text-center text-sm font-medium border-r border-base-300 last:border-r-0'>
                    {day}
                  </div>
                ))}
              </div>
              ...
              <div className='grid grid-cols-7'>
                {Array.from({ length: 35 }, (_, i) => {
                  ...
                  return (
                    ...
                    >
                      <div className={`text-sm ${isCurrentMonth ? 'text-base-content' : 'text-base-content/30'} ${isToday ? 'font-bold' : ''}`}>
            ...
            <div className='mt-4 text-center text-base-content/70'>
              <p>Integrated scheduling workflow will be implemented in future stories.</p>
              <p className='text-sm mt-1'>Drag-and-drop content scheduling coming soon!</p>
            </div>
          </div>
        </div>
      </div>
