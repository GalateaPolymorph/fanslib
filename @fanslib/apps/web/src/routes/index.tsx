  ...
  <div className='container mx-auto max-w-7xl'>
    ...
    <div className='mb-6 lg:mb-8'>
      ...
      <div className='grid grid-cols-2 sm:grid-cols-4 lg:flex lg:flex-wrap gap-3 lg:gap-4 lg:justify-center'>
        ...
        <button className='btn btn-secondary btn-sm lg:btn-md'>
          Secondary
        </button>
    ...
    <div className='mb-6 lg:mb-8'>
      ...
      <div className='grid grid-cols-1 sm:grid-cols-2 lg:flex lg:flex-wrap gap-3 lg:gap-4 lg:justify-center'>
        ...
        <button className='btn btn-primary btn-outline btn-sm lg:btn-md'>
          Outline
        </button>
        <button className='btn btn-primary btn-ghost btn-sm lg:btn-md'>
          Ghost
        </button>
