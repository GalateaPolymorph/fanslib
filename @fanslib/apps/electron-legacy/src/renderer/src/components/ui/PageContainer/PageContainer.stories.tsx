...
export const NoSpacing: Story = {
  render: () => (
    <PageContainer spacing="none">
      ...
      <div className="bg-muted p-4 rounded">Section 3 - Add your own spacing as needed</div>
    </PageContainer>
  ),
};
...
export const SmallSpacing: Story = {
  render: () => (
    <PageContainer spacing="sm">
      ...
      <div className="bg-muted p-4 rounded">Section 3 - Minimal gaps</div>
    </PageContainer>
  ),
};
...
export const LargeSpacing: Story = {
  render: () => (
    <PageContainer spacing="lg">
      ...
      <div className="bg-muted p-4 rounded">Section 3 - Generous gaps</div>
    </PageContainer>
  ),
};
        ...
        <div className="space-y-4">
          {[
            ...
            <div key={width}>
              ...
              >
                <div className="bg-primary/10 p-2 text-center">{label} container</div>
              </PageContainer>
            </div>
          ))}
        </div>
