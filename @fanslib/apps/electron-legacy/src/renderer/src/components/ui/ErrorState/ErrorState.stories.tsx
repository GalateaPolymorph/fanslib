...
import { ErrorState, NetworkErrorState, GenericErrorState, NotFoundErrorState } from "./ErrorState";
...
export const NetworkError: Story = {
  render: () => <NetworkErrorState onRetry={() => console.log("Network retry clicked")} />,
};

export const GenericError: Story = {
  render: () => <GenericErrorState onRetry={() => console.log("Generic retry clicked")} />,
};

export const NotFoundError: Story = {
  render: () => <NotFoundErrorState resourceName="Page" />,
};
...
export const NotFoundCustomResource: Story = {
  render: () => (
    <NotFoundErrorState
      ...
      action={<Button variant="outline">Browse Library</Button>}
    />
  ),
};
