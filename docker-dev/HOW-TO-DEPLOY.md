...
```bash
docker build -t fanslib-dev -f /mnt/user/appdata/fanslib/git/docker-dev/Dockerfile /mnt/user/appdata/fanslib/git/docker-dev
```
...
# Erste Mal: Dependencies installieren
